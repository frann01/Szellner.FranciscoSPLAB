 ...
 *
 * \param void* this LinkedList a filtrar
 * \param void* (int) pfunc* funcion q filtra
 * \return LinkedList* puntero a nueva LinkedList
 *
 */
    ...
    if(this != NULL && pFunc != NULL)
    {
        ...
        if(listaNueva!=NULL)
        {
            ...
            for(int i=0; i< tam; i++)
            {
                ...
                if(pFunc(Element)==1)
                {
                    if(ll_add(listaNueva, Element)==-1)
                    {
